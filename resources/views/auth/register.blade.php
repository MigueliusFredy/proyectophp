        ...
        <div class="card rounded-3 text-black">
          <div class="row g-0">
            <div class="col-lg-6">
              <div class="card-body p-md-5 mx-md-4">
                ...
                <div class="text-center">
                  <img src="{{ asset('assets/argym.jpg')}}"
            ...
            <div class="col-lg-6 d-flex align-items-center gradient-custom-2">
              ...
              <h4 class="mb-4">Que es la escuela Argym</h4>
                <p class="small mb-0">Escuela fundada en el 2008 con la finalidad de atender las necesidades educativas de los estudiantes y/o personas con dificultades académicas y de aprendizaje, tales como: dificultades en asignaturas específicas, necesidad de refuerzo académico y más, para mejorar su rendimiento escolar y alcanzar sus metas educativas.</p>
              </div>
            </div>
          </div>
        </div>
